/*
 * package com.cts.project.restdemo.config;
 * 
 ...
 * 
 * private ApiInfo metaData() { return new ApiInfo( "product",
 * "product details end points", "1.0", "Terms of service", new
 * Contact("cognizant", "www.cognizant.com", "myemail@gmail.com"),
